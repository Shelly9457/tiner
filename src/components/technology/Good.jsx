        ...
        <div className="w-full ">
            <div className="grid md:grid-cols-4 grid-cols-1 gap-8 items-center justify-items-center my-7">
                <div className="font-bold text-(--one) col-span-2 sm:w-[80%] w-full sm:ms-auto text-center md:text-start">
                    <h1 className="text-2xl text-center">高效能源轉換</h1>
                    <p className="text-lg whitespace-pre-line text-center">
                        燃料電池發電效率高達 50%～73%，<br />
                        遠超過柴油或汽油發電機的35%～40%
                    </p>
                </div>
            ...
            <div className="grid md:grid-cols-4 grid-cols-1 gap-8 items-center justify-items-center my-7">
                ...
                <div className="flex flex-col gap-5 font-bold text-(--one) col-span-2 sm:w-[70%] w-full sm:ms-auto text-center md:text-end">
                    <h1 className="text-2xl  text-center">&gt;95%</h1>
                    <div className="w-full h-[2px] bg-(--one)"></div>
                    <p className="text-2xl  text-center">熱電聯供效率</p>
                </div>
            </div>
            <div className="grid md:grid-cols-4 grid-cols-1 gap-8 items-center justify-items-center my-7">
                <div className="font-bold text-(--one) col-span-2 sm:w-[80%] w-full sm:ms-auto text-center md:text-start">
                    <h1 className="text-2xl  text-center">穩定輸出，歷久彌新</h1>
                    <p className="text-lg whitespace-pre-line  text-center">
                        系統在 10,000 小時運行<br />
                        仍可維持穩定輸出與低能量衰減，<br />
                        長期確保性能穩定
            ...
            <div className="grid md:grid-cols-4 grid-cols-1 gap-8 items-center justify-items-center my-7">
                ...
                <div className="flex flex-col gap-5 font-bold text-(--one) col-span-2 sm:w-[70%] w-full sm:ms-auto text-center md:text-end">
                    <h1 className="text-2xl  text-center">30,000～50,000hr</h1>
                    <div className="w-full h-[2px] bg-(--one)"></div>
                    <p className="text-2xl  text-center">長壽命設計</p>
                </div>
            </div>
        </div >
    )
