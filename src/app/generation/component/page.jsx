...
const component = () => {
    ...
    return (
        <>
            <HeaderVideo title={"高效能的氫能核心動力"} desc={"電池元件"} video={"https://dl.dropboxusercontent.com/scl/fi/pkgtkfxub9u8m61y9htjk/prduct_english.mp4?rlkey=8z87u91t9tbs3jrfij4rgu1sy&st=besi96ja&raw=1"}></HeaderVideo>
