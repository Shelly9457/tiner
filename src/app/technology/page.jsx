...
import MainBattery from "@/components/techtology/MainBattery";
import Good from "@/components/techtology/Good";
const about = () => {
    return (
        <>
            ...
            <section className="container py-16 w-full md:w-[80%] mx-auto gap-5 center gap-5 min-h-screen flex-col">
